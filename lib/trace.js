...
Trace.prototype.getLoadRecord = function(canonical, traceOpts, parentStack) {
  ...
  .then(function(normalized) {
    ...
    var load = {
      ...
      // true if working with instrumented source from systemjs-istanbul-hook
      instrumentedSource: false
    };
    var curHook = 'locate';
    var originalSource;
    ...
    .then(function(address) {
      ...
      .then(function() {
        ...
        .then(function(source) {
          ...
          // keep track of instrumented source while getting dependencies
          if (load.metadata.instrumentedSource)
            instrumentedSource = load.source;
      ...
      .then(function() {
        ...
        // dependencies are gotten, now give me back my instrumented source
        if (load.metadata.instrumentedSource && instrumentedSource) {
          load.source = instrumentedSource;
        }
